...
\multicolumn{7}{L{0.731\linewidth-2\tabcolsep-.6pt}|}{Đặc tả chức năng quản lý bạn bè của người dùng}\\\hline
%Row 4
...
\multicolumn{7}{L{0.731\linewidth-2\tabcolsep-.6pt}|}{Người dùng chọn chức năng quản lý bạn bè trên giao diện}\\\hline
%Row 6
...
\multicolumn{3}{L{0.427\linewidth-2\tabcolsep-.6pt}|}{Hiển thị danh sách bàn bè theo thứ tự nhắn tin gần nhất, kèm theo đó là một ô cho phép người dùng tìm kiếm theo tên} \\ \hline
%
%Subflow
%Alter flow
\end{longtable}
