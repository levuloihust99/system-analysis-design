...
\multicolumn{7}{L{0.731\linewidth-2\tabcolsep-.6pt}|}{Đặc tả chức năng tìm kiếm của người dùng}\\\hline
%Row 4
...
\multicolumn{7}{L{0.731\linewidth-2\tabcolsep-.6pt}|}{Người dùng nhập tên người chơi và chọn tìm kiếm}\\\hline
%Row 6
...
\multicolumn{3}{L{0.427\linewidth-2\tabcolsep-.6pt}|}{Hiện thị danh sách người chơi có tên chứa từ khóa người dùng nhập theo thứ tự  bàn bè trước, người lạ sau} \\ \hline
%
%Subflow
%Alter flow
\end{longtable}
