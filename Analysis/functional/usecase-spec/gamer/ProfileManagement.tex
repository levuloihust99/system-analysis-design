...
\multicolumn{7}{L{0.731\linewidth-2\tabcolsep-.6pt}|}{Mô tả chức năng quản lý profile của người dùng}\\\hline
%Row 4
...
\multicolumn{7}{L{0.731\linewidth-2\tabcolsep-.6pt}|}{Người dùng chọn chức năng quản lý profile từ giao diện}\\\hline
%Row 6
\multicolumn{2}{|M{0.280\linewidth-2\tabcolsep-.6pt}|}{\cellcolor{blue!20}\textbf{Điểm mở rộng}} &
\multicolumn{7}{L{0.731\linewidth-2\tabcolsep-.6pt}|}{4UCS}\\\hline
%Normal flow
...
\multicolumn{3}{L{0.427\linewidth-2\tabcolsep-.6pt}|}{Người dùng chọn chức năng quản lý profile từ giao diện người chơi} \\ \cline{3-9}
%
...
\multicolumn{3}{L{0.427\linewidth-2\tabcolsep-.6pt}|}{ Hiển thị giao diện gồm thông tin cá nhân của người dùng, kèm theo đó là 4 options:  đổi mật khẩu, cập nhật ảnh đại diện, cập nhật số điện thoại, thiết lập bảo mật hai lớp} \\ \hline
%
%Subflow
%Alter flow
\end{longtable}
