...
\multicolumn{7}{L{0.731\linewidth-2\tabcolsep-.6pt}|}{Đặc tả chức năng quản lý kho nhân vật của người dùng}\\\hline
%Row 4
...
\multicolumn{7}{L{0.731\linewidth-2\tabcolsep-.6pt}|}{Người dùng chọn chức năng quản lý kho nhân vật trên giao diện}\\\hline
%Row 6
\multicolumn{2}{|M{0.280\linewidth-2\tabcolsep-.6pt}|}{\cellcolor{blue!20}\textbf{Điểm mở rộng}} &
\multicolumn{7}{L{0.731\linewidth-2\tabcolsep-.6pt}|}{1 UC}\\\hline
%Normal flow
...
\multicolumn{3}{L{0.427\linewidth-2\tabcolsep-.6pt}|}{Hiển thị danh sách các nhân vật của người dùng} \\ \hline
%
%Subflow
%Alter flow
\end{longtable}
