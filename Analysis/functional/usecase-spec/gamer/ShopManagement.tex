...
\multicolumn{7}{L{0.731\linewidth-2\tabcolsep-.6pt}|}{Đặc tả chức năng quản lý mua sắm của người dùng}\\\hline
%Row 4
...
\multicolumn{7}{L{0.731\linewidth-2\tabcolsep-.6pt}|}{Người dùng chọn chức năng quản lý mua sắm trên giao diện}\\\hline
%Row 6
...
\multicolumn{3}{L{0.427\linewidth-2\tabcolsep-.6pt}|}{Hiển thị giao diện gồm danh sách các trang bị, nhân vật đề xuất và một bộ lọc  cho phép người dùng tìm kiếm sản phẩm} \\ \hline
%
%Subflow
%Alter flow
\end{longtable}
